    ...
    public void LicenseIssuerGuide_DocumentsCommandsProfilesAndFeatureRules()
    {
        ...
        AssertGuideContainsAll(
            ...
            [
                ...
                "PASTE-INSTALLATION-ID-FROM-PROMREQUEST",
                "Test-Path $requestPath",
                "notepad $requestPath",
                "OK: installationId вставлен",
                "OK: срок выбран",
                "OK: profile created:",
                "licensePath должен быть путем к .promlicense файлу",
                "Cannot bind argument to parameter 'Path'",
                "Missing required option \"--profile\"",
                "full-package-1-day-profile.json",
                "full-package-30-days-profile.json",
                "full-package-1-year-profile.json",
                "validFromUtc + 365 days",
                "License key id is not trusted",
                "UnknownKeyId",
                "AppContext.BaseDirectory",
                "production-key-2026-01.public.json",
                "PublicKeyPem",
                "IsTestKey",
                "полностью закройте приложение",
                "Get-ChildItem .\\license-work",
                "InvalidSignature",
                "InstallationMismatch",
                "ProductVersionUnsupported",
                "Expired",
                "NotYetValid",
                "TestKeyRejected",
                "TrustedPublicKeys"
