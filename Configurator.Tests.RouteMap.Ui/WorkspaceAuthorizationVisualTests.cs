...
public sealed class WorkspaceAuthorizationVisualTests
{
    ...
    public async Task AdminWorkspaceRendersAuthorizedHeaders()
    {
        ...
        Assert.Equal(["Route Map", "SignalId ↔ Modbus", "Modbus TCP", "Modbus Demo", "Archive", "License", "Users"], fixture.Headers());
    }
    ...
    private sealed class WorkspaceFixture : IDisposable
    {
        ...
        [
            ...
            new("modbus-tcp", "Modbus TCP", Permission.ConfigureModbus, LicenseFeature.Diagnostics, _ => new object(), 15),
